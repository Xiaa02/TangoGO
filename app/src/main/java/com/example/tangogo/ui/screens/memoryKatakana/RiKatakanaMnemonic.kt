...
fun RiKatakanaMnemonicScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("リ - ri", fontSize = 25.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 20.dp))
            ...
            Box(
                ...
                Image(
                    painter = painterResource(id = R.drawable.ri_katakana_memory),
                    contentDescription = "Katakana リ",
