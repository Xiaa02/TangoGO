...
fun KaKatakanaWriteScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("カ – ka", fontSize = 25.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 20.dp))

            Spacer(modifier = Modifier.height(16.dp))

            Column(horizontalAlignment = Alignment.CenterHorizontally) {
                Box(modifier = Modifier.size(300.dp).background(Color.White, RoundedCornerShape(16.dp))) {
                    Canvas(
                        ...
                        drawIntoCanvas {
                            ...
                            it.nativeCanvas.drawText("カ", cx, cy + paint.textSize / 3f, paint)
                        }
...
@Composable
fun KaKatakanaWriteScreenPreview() {
