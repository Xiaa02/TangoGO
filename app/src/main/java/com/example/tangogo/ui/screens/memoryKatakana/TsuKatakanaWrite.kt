...
fun TsuKatakanaWriteScreen(
    ...
    val correctSheetState = rememberModalBottomSheetState(skipPartiallyExpanded = true, confirmValueChange = { false })
    val wrongSheetState = rememberModalBottomSheetState(skipPartiallyExpanded = true, confirmValueChange = { false })
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("ツ – tsu", fontSize = 25.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 20.dp))
                ...
                Box(
                    ...
                    Canvas(
                        ...
                        drawIntoCanvas {
                            ...
                            it.nativeCanvas.drawText("ツ", cx, cy + paint.textSize / 3f, paint)
                        }
                    ...
                    Icon(Icons.AutoMirrored.Filled.VolumeUp, "Play", tint = Color.Unspecified, modifier = Modifier
                        .align(Alignment.TopEnd)
                        .padding(8.dp)
                        .size(28.dp)
                        .clickable {
                            playSound(context, R.raw.tsu)
                        })

                    Icon(Icons.Default.Delete, "Clear", modifier = Modifier
...
@Composable
fun TsuKatakanaWriteScreenPreview() {
