...
fun ShiKatakanaWriteScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("シ – shi", fontSize = 25.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 20.dp))
                ...
                Box(
                    ...
                    Canvas(
                        ...
                        drawIntoCanvas {
                            ...
                            it.nativeCanvas.drawText("シ", cx, cy + paint.textSize / 3f, paint)
                        }
...
@Composable
fun ShiKatakanaWriteScreenPreview() {
