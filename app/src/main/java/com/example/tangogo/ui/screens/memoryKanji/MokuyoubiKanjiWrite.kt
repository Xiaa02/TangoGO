                ...
                Box(
                    ...
                    Canvas(
                        ...
                        drawIntoCanvas {
                            ...
                            it.nativeCanvas.drawText("木", cx, cy + paint.textSize / 3f, paint)
                        }
                    ...
                    Icon(Icons.AutoMirrored.Filled.VolumeUp, "Play", tint = Color.Unspecified, modifier = Modifier.align(Alignment.TopEnd).padding(8.dp).size(28.dp).clickable {
                        playSound(context, R.raw.mokuyoubi)
                    })
...
@Composable
fun MokuyoubiKanjiWriteScreenPreview() {
