...
fun SuKatakanaWriteScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("ス – su", fontSize = 25.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 20.dp))
                ...
                Box(
                    ...
                    Canvas(
                        ...
                        drawIntoCanvas {
                            ...
                            it.nativeCanvas.drawText("ス", cx, cy + paint.textSize / 3f, paint)
                        }
...
@Composable
fun SuKatakanaWriteScreenPreview() {
