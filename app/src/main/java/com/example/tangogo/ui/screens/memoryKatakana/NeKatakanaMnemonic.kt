...
fun NeKatakanaMnemonicScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("ネ - ne", fontSize = 25.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 20.dp))
            ...
            Box(
                ...
                Image(
                    painter = painterResource(id = R.drawable.ne_katakana_memory),
                    contentDescription = "Katakana ネ",
