        ...
        Box(
            ...
            Column(
                ...
                val learningPoints = listOf(
                    "カタカナを よむ ほうほう。" to "How to read Katakana",
                    "カタカナの おん。" to "Pronunciation of Katakana sounds.",
                    "カタカナを つかった ことば。" to "Simple words using Katakana."
                )
...
@Composable
fun KatakanaWelcomeScreenPreview() {
