        ...
        Box(
            ...
            Column(
                ...
                val learningPoints = listOf(
                    "あなたは ひるごはんを いつも どこで たべますか。" to "Where do you always have lunch?",
                    "ファーストフードのみせで たべますか。なにを たべますか。" to "Do you eat at fast food restaurants? What do you have?"
                )
