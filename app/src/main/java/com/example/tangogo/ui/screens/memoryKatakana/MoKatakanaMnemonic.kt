...
fun MoKatakanaMnemonicScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("モ - mo", fontSize = 25.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 20.dp))
            ...
            Box(
                ...
                Image(
                    painter = painterResource(id = R.drawable.mo_katakana_memory),
                    contentDescription = "Katakana モ",
