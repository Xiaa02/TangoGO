...
fun TaKatakanaWriteScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("タ – ta", fontSize = 25.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 20.dp))
                ...
                Box(
                    ...
                    Canvas(
                        ...
                        drawIntoCanvas {
                            ...
                            it.nativeCanvas.drawText("タ", cx, cy + paint.textSize / 3f, paint)
                        }
...
@Composable
fun TaKatakanaWriteScreenPreview() {
