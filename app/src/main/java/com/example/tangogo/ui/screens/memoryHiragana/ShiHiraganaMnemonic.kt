    ...
    Scaffold(
        ...
        Column(
            ...
            Box(
                ...
                Image(
                    painter = painterResource(id = R.drawable.shi_hiragana_memory),
                    contentDescription = "Hiragana Shi",
...
@Composable
fun ShiHiraganaMnemonicScreenPreview() {
