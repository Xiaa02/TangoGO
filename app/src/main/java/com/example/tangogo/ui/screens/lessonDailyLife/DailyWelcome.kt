        ...
        Box(
            ...
            Column(
                ...
                val learningPoints = listOf(
                    "いま　なんじですか。" to "What time is it now?",
                    "まいにち　なんじに　おきますか。なんじに　ねますか。" to "What time do you get up and go to bed every day?"
                )
