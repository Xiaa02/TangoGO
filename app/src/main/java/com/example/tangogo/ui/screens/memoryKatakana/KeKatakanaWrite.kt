...
fun KeKatakanaWriteScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("ケ – ke", fontSize = 25.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 20.dp))
                ...
                Box(
                    ...
                    Canvas(
                        ...
                        drawIntoCanvas {
                            ...
                            it.nativeCanvas.drawText("ケ", cx, cy + paint.textSize / 3f, paint)
                        }
...
@Composable
fun KeKatakanaWriteScreenPreview() {
