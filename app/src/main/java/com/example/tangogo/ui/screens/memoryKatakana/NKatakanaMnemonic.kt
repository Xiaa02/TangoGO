...
fun NKatakanaMnemonicScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("ン - n", fontSize = 25.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 20.dp))
            ...
            Box(
                ...
                Image(
                    painter = painterResource(id = R.drawable.n_katakana_memory),
                    contentDescription = "Katakana ン",
