...
fun HaKatakanaMnemonicScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("ハ - ha", fontSize = 25.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 20.dp))
            ...
            Box(
                ...
                Image(
                    painter = painterResource(id = R.drawable.ha_katakana_memory),
                    contentDescription = "Katakana ハ",
