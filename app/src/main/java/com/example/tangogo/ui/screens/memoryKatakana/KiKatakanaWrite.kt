...
fun KiKatakanaWriteScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("キ – ki", fontSize = 25.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 20.dp))
                ...
                Box(
                    ...
                    Canvas(
                        ...
                        drawIntoCanvas {
                            ...
                            it.nativeCanvas.drawText("キ", cx, cy + paint.textSize / 3f, paint)
                        }
...
@Composable
fun KiKatakanaWriteScreenPreview() {
