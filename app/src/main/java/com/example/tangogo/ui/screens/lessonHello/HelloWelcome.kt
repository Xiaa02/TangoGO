        ...
        Box(
            ...
            Column(
                ...
                val learningPoints = listOf(
                    "はじめて あった ひとと どんな あいさつを しますか。" to "How do you greet people when you meet them for the first time?",
                    "はじめて あった ひとと なにを はなしますか。" to "What do you talk about with people you meet for the first time?"
                )
