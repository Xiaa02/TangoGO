    ...
    Scaffold(
        ...
        Column(
            ...
            Box(
                ...
                Text("ウ", fontSize = 200.sp, fontWeight = FontWeight.Normal)
                Icon(
                    ...
                    modifier = Modifier
                        ...
                        .size(28.dp)
                        .clickable {
                            playSound(context, R.raw.u) // Ensure R.raw.u exists
                        }
                )
            }
...
@Composable
fun UKatakanaMemoryScreenPreview() {
