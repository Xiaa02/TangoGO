...
fun FuKatakanaMnemonicScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("フ - fu", fontSize = 25.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 20.dp))
            ...
            Box(
                ...
                Image(
                    painter = painterResource(id = R.drawable.fu_katakana_memory),
                    contentDescription = "Katakana フ",
