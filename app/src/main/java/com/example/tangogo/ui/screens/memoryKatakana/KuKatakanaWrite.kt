...
fun KuKatakanaWriteScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("ク – ku", fontSize = 25.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 20.dp))
                ...
                Box(
                    ...
                    Canvas(
                        ...
                        drawIntoCanvas {
                            ...
                            it.nativeCanvas.drawText("ク", cx, cy + paint.textSize / 3f, paint)
                        }
...
@Composable
fun KuKatakanaWriteScreenPreview() {
