...
fun TeKatakanaMnemonicScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("テ - te", fontSize = 25.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 20.dp))
            ...
            Box(
                ...
                Image(
                    painter = painterResource(id = R.drawable.te_katakana_memory),
                    contentDescription = "Katakana テ",
