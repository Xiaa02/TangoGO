                ...
                Box(
                    ...
                    Canvas(
                        ...
                        drawIntoCanvas {
                            ...
                            it.nativeCanvas.drawText("食", cx, cy + paint.textSize / 3f, paint)
                        }
                    ...
                    Icon(Icons.AutoMirrored.Filled.VolumeUp, "Play", tint = Color.Unspecified, modifier = Modifier.align(Alignment.TopEnd).padding(8.dp).size(28.dp).clickable {
                        playSound(context, R.raw.tabemasu)
                    })
...
@Composable
fun TabemasuKanjiWriteScreenPreview() {
