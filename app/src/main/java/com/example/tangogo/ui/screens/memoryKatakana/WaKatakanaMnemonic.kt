...
fun WaKatakanaMnemonicScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("ワ - wa", fontSize = 25.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 20.dp))
            ...
            Box(
                ...
                Image(
                    painter = painterResource(id = R.drawable.wa_katakana_memory),
                    contentDescription = "Katakana ワ",
