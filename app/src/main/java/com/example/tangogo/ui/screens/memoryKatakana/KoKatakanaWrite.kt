...
fun KoKatakanaWriteScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("コ – ko", fontSize = 25.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 20.dp))
                ...
                Box(
                    ...
                    Canvas(
                        ...
                        drawIntoCanvas {
                            ...
                            it.nativeCanvas.drawText("コ", cx, cy + paint.textSize / 3f, paint)
                        }
...
@Composable
fun KoKatakanaWriteScreenPreview() {
