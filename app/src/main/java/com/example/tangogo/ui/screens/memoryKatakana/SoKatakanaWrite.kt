...
fun SoKatakanaWriteScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("ソ – so", fontSize = 25.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 20.dp))
                ...
                Box(
                    ...
                    Canvas(
                        ...
                        drawIntoCanvas {
                            ...
                            it.nativeCanvas.drawText("ソ", cx, cy + paint.textSize / 3f, paint)
                        }
...
@Composable
fun SoKatakanaWriteScreenPreview() {
