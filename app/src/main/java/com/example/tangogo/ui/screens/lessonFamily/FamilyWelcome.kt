        ...
        Box(
            ...
            Column(
                ...
                val learningPoints = listOf(
                    "はじめて あった ひとと かぞくについて なにを はなしますか。" to "What do you say about your family when you meet people for the first time?",
                    "かぞくの しゃしんを みて なにを はなしますか。" to "What do you talk about when you look at a family photo?"
                )
...
@Composable
fun FamilyWelcomeScreenPreview() {
    FamilyWelcomeScreen(
        navigateBack = {},
        navigateToNext = {}
    )
