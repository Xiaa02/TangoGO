...
fun ReKatakanaMnemonicScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("レ - re", fontSize = 25.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 20.dp))
            ...
            Box(
                ...
                Image(
                    painter = painterResource(id = R.drawable.re_katakana_memory),
                    contentDescription = "Katakana レ",
