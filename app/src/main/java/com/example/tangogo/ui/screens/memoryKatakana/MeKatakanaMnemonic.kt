...
fun MeKatakanaMnemonicScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("メ - me", fontSize = 25.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 20.dp))
            ...
            Box(
                ...
                Image(
                    painter = painterResource(id = R.drawable.me_katakana_memory),
                    contentDescription = "Katakana メ",
