...
fun SaKatakanaWriteScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("サ – sa", fontSize = 25.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 20.dp))
                ...
                Box(
                    ...
                    Canvas(
                        ...
                        drawIntoCanvas {
                            ...
                            it.nativeCanvas.drawText("サ", cx, cy + paint.textSize / 3f, paint)
                        }
...
@Composable
fun SaKatakanaWriteScreenPreview() {
