...
fun RoKatakanaMnemonicScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("ロ - ro", fontSize = 25.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 20.dp))
            ...
            Box(
                ...
                Image(
                    painter = painterResource(id = R.drawable.ro_katakana_memory),
                    contentDescription = "Katakana ロ",
