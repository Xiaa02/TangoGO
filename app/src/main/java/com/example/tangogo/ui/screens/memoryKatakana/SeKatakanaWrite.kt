...
fun SeKatakanaWriteScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text("セ – se", fontSize = 25.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 20.dp))
                ...
                Box(
                    ...
                    Canvas(
                        ...
                        drawIntoCanvas {
                            ...
                            it.nativeCanvas.drawText("セ", cx, cy + paint.textSize / 3f, paint)
                        }
...
@Composable
fun SeKatakanaWriteScreenPreview() {
