...
import com.example.tangogo.network.HiraganaRequest
import com.example.tangogo.network.HiraganaResponse
import com.example.tangogo.network.RetrofitClient
    ...
    Scaffold(
        ...
        if (currentCard != null) {
            Column(
                ...
                Text("Vocabulary", fontSize = 20.sp, fontWeight = FontWeight.Normal, color = Color.DarkGray, textAlign = TextAlign.Start, modifier = Modifier.fillMaxWidth().padding(start = 20.dp, top = 8.dp, bottom = 8.dp))
                Text("きいて はなして", fontSize = 20.sp, fontWeight = FontWeight.Bold, modifier = Modifier.fillMaxWidth().padding(start = 20.dp, top = 8.dp, bottom = 2.dp), textAlign = TextAlign.Start)
                Text("Listen and speak", fontSize = 18.sp, fontWeight = FontWeight.Normal, color = Color.DarkGray, modifier = Modifier.fillMaxWidth().padding(start = 20.dp, bottom = 12.dp), textAlign = TextAlign.Start)
