...
import com.example.tangogo.ui.screens.lessonHiragana.Hiragana3Screen
...
fun NavGraphBuilder.tangoGOGraph(appState: TangoGOAppState) {
    ...
    composable(Routes.LESSON_HIRAGANA2) {
        Hiragana2Screen(
            ...
            navigateToHiragana3 = { appState.navController.navigate(Routes.LESSON_HIRAGANA3) }
        )
    }
    composable(Routes.LESSON_HIRAGANA3) {
        Hiragana3Screen(
            navigateBack = { appState.popUp() },
            navigateToDashboard = { appState.clearAndNavigate(Routes.DASHBOARD) }
        )
